...
static injector_channel_t injectors[4] = {
    {LEDC_CHANNEL_0, INJECTOR_GPIO_1, 0, false},
    {LEDC_CHANNEL_1, INJECTOR_GPIO_2, 0, false},
    {LEDC_CHANNEL_2, INJECTOR_GPIO_3, 0, false},
    {LEDC_CHANNEL_3, INJECTOR_GPIO_4, 0, false},
};
